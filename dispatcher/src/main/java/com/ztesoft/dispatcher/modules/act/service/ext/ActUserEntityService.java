package com.ztesoft.dispatcher.modules.act.service.ext;
...
//		}
        ...
        if (user != null) {
            getSystemService().deleteUser(new com.ztesoft.dispatcher.modules.sys.entity.User(user.getId()));
        }
    }
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
        ...
        for (Role role : getSystemService().findRole(new Role(new com.ztesoft.dispatcher.modules.sys.entity.User(null, userId)))) {
