...
<ul class="nav nav-tabs">
    ...
    <li class="active"><a href="${ctx}/test/testDataMain/form?id=${testDataMain.id}">主子表<shiro:hasPermission
            name="test:testDataMain:edit">${not empty testDataMain.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission
            name="test:testDataMain:edit">查看</shiro:lacksPermission></a></li>
</ul>
<br/>
<form:form id="inputForm" modelAttribute="testDataMain" action="${ctx}/test/testDataMain/save" method="post"
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <sys:treeselect id="user" name="user.id" value="${testDataMain.user.id}" labelName="user.name"
                            labelValue="${testDataMain.user.name}"
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <sys:treeselect id="office" name="office.id" value="${testDataMain.office.id}" labelName="office.name"
                            labelValue="${testDataMain.office.name}"
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <sys:treeselect id="area" name="area.id" value="${testDataMain.area.id}" labelName="area.name"
                            labelValue="${testDataMain.area.name}"
    ...
    <div class="form-actions">
        <shiro:hasPermission name="test:testDataMain:edit"><input id="btnSubmit" class="btn btn-primary" type="submit"
