...
<div class="wrapper">
    <div class="header">
        ...
        <a href="javascript:history.go(-2);" target="_blank">
    ...
    <div class="content_wrapper">
        <div class="content">
            ...
            <form class="lybinput" id="lyform" action="" method="POST">
                <div class="nicheng">
                    <div>
                        <input class="nicheng_02 form-control" name="name" value="" type="text" placeholder="请输入昵称"
                               required="required">
                    </div>
                </div>
                ...
                <div class="liuyan">
                    <div>
                        <input class="nicheng_02 form-control" name="content" id="textinput1" placeholder="请输入您的留言"
            ...
            <c:forEach items="${page.list}" var="guestbook" varStatus="vs">
                ...
                <div class="neirong_001_buttom">
                    ...
                    <div class="chakang"><a></a></div>
                    <div class="fanghui fh"><a>返回</a></div>
                    <div class="fanghui quit"><a>取消</a></div>
                </div>
                <div class="reply">
                    <div class="neirong_001_smm">
                        <div class="zhuyaoneirong_smm"><strong
                                style="color: #000">${guestbook.reUser.name}: </strong>${guestbook.reContent}</div>
                    </div>
            ...
            <form class="ly_reply" action="http://shibo.55zhe.net/wz.php?mod=board&boardid=1299&openid=fromuserid"
                  method="POST">
                <div class="nicheng">
                    <div>
                        <input class="nicheng_02 form-control rnickname" name="reply_nickname" type="text" value=""
                               placeholder="请输入昵称"/>
                    </div>
                </div>
                ...
                <div class="liuyan">
                    <div>
                        <input class="nicheng_02 form-control" name="reply_content" placeholder="请输入您的回复" value=""
                               type="text">
                    </div>
                </div>
