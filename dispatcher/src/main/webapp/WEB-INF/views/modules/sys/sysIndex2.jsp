...
<div id="main">
            ...
            <ul id="userControl" class="nav pull-right"><%--
                ...
                <li id="themeSwitch" class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            <a href="javascript:cookie('tabmode','${cookie.tabmode.value eq '1' ? '0' : '1'}');location=location.href">${cookie.tabmode.value eq '1' ? '关闭' : '开启'}页签模式</a>
                        </li>
                    </ul>
                    <!--[if lte IE 6]>
    ...
    <div class="container-fluid">
        ...
        <div id="footer" class="row-fluid">
            ...
            ${fns:getConfig('productName')}<!--  - Powered By <a href="https://github.com.ztesoft.dispatcher" target="_blank">JeeSite</a> ${fns:getConfig('version')} -->
        </div>
    </div>
</div>
<script type="text/javascript">
