...
<ul class="nav nav-tabs">
    ...
    <li class="active"><a href="${ctx}/gen/genTemplate/form?id=${genTemplate.id}">代码模板<shiro:hasPermission
            name="gen:genTemplate:edit">${not empty genTemplate.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission
            name="gen:genTemplate:edit">查看</shiro:lacksPermission></a></li>
</ul>
<br/>
<form:form id="inputForm" modelAttribute="genTemplate" action="${ctx}/gen/genTemplate/save" method="post"
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <form:textarea id="content" htmlEscape="true" path="content" rows="25" class="required" style="width:90%;"
                           wrap="off"/>
            <script type="text/javascript">
    ...
    <div class="form-actions">
        <shiro:hasPermission name="gen:genTemplate:edit"><input id="btnSubmit" class="btn btn-primary" type="submit"
