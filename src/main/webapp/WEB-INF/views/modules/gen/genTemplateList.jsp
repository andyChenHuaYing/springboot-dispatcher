...
<form:form id="searchForm" modelAttribute="genTemplate" action="${ctx}/gen/genTemplate/" method="post"
...
<div id="messageBoxError" class="alert alert-error">
    ...
    代码模板管理，已废弃！模板管理改为XML配置方式，见 /src/main/java/com.ztesoft.dispatcher/modules/gen/template 文件夹
</div>
        ...
        <tr>
            ...
            <shiro:hasPermission name="gen:genTemplate:edit">
                <td>
                    ...
                    <a href="${ctx}/gen/genTemplate/delete?id=${genTemplate.id}"
                       onclick="return confirmx('确认要删除该代码模板吗？', this.href)">删除</a>
                </td>
            </shiro:hasPermission>
        </tr>
    </c:forEach>
